...
<section class="category-page-wrapper">
    ...
    <div class="category-content">
        <h2 class="section-title" style="text-align: left;">Best Sellers</h2>
        
        <div class="category-search-wrapper" style="margin: 0 0 30px 0;">
            <input type="text" id="categorySearchInput" placeholder="Search best sellers..." onkeyup="filterCategoryProducts()">
