...
<section class="category-page-wrapper">
    ...
    <div class="category-content">
        <div class="category-header-toolbar" style="display:flex; flex-wrap:wrap; justify-content:space-between; align-items:center; margin-bottom:20px; gap:15px; border-bottom:1px solid #eee; padding-bottom:15px;">
            <div>
                <h2 class="section-title" style="text-align: left; margin:0; font-size:1.8rem; font-family:var(--font-heading);">New <span style="color:var(--primary-gold)">Arrivals</span></h2>
                <p style="color:var(--text-grey); font-size:0.88rem; margin-top:4px;" id="productsCount">Loading new arrivals...</p>
            </div>
        ...
        <div class="category-search-wrapper">
            <input type="text" id="categorySearchInput" placeholder="Search new arrivals..." oninput="applyFilters()" onkeyup="applyFilters()">
